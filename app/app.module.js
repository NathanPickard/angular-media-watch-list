System.register(["@angular/core", "@angular/platform-browser", "@angular/forms", "@angular/http", "./app.component", "./media-item.component", "./media-item-list.component", "./favorite.directive", "./category-list.pipe", "./media-item-form.component", "./media-item.service", "./providers"], function (exports_1, context_1) {
    "use strict";
